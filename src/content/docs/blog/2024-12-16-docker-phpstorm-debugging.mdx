...
6. Configure path mappings between PhpStorm and the Docker container.
    ...
    ![](../../../assets/blog-posts/2024-12-16-docker-phpstorm-debugging/phpstorm-path-mapping.png)

7. Create a PhpStorm PHP Remote Debug configuration.

    ![](../../../assets/blog-posts/2024-12-16-docker-phpstorm-debugging/phpstorm-debugging-run-configuration.png)
...
8. Run the PhpStorm PHP Remote Debug configuration, set a breakpoint and make sure PhpStorm is listening for incoming connection.
    ...
    ![](../../../assets/blog-posts/2024-12-16-docker-phpstorm-debugging/phpstorm-running-run-configuration.png)
...
10. Set a breakpoint and enjoy your debugging experience!
    ...
    ![](../../../assets/blog-posts/2024-12-16-docker-phpstorm-debugging/phpstorm-breakpoint-hit.png)
